...
```{r}
mats <- list()
mats$kallisto <- read_count_output(paste0("../kallisto_out_ensembl/", name_use),
                                   name = "genes", tcc = FALSE)
mats$cellranger <- read_cellranger(paste0("../cellranger_out_ensembl/cellranger3_",
                                          name_use, "_out/outs/raw_feature_bc_matrix"))
